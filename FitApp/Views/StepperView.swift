...
@IBDesignable public class StepperView: UIControl {
    ...
    @objc @IBInspectable public var buttonsBackgroundColor: UIColor = UIColor(red:0.21, green:0.5, blue:0.74, alpha:0) {
        didSet {
            for button in [leftButton, rightButton] {
    ...
    */
    ...
    fileprivate func setup() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(StepperView.reset), name: UIApplication.willResignActiveNotification, object: nil)
    }
    ...
    public override func layoutSubviews() {
        ...
        let labelWidth = (frame.size.width - (buttonWidth * 2))
